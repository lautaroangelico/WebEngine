...
$voteLogs = $dB->query_fetch("SELECT TOP 100 user_id, COUNT(*) as totalvotes FROM WEBENGINE_VOTE_LOGS WHERE timestamp BETWEEN ? AND ? GROUP BY user_id ORDER BY totalvotes DESC", array($ts1,$ts2));
