...
try {
	...
	echo '<div class="page-title"><span><i class="fa-solid fa-trophy"></i> Top Killers</span></div>';
	...
	echo '<td style="font-weight:bold;"><i class="fa-solid fa-fire"></i> '.lang('rankings_txt_12').'</td>';
	echo '<td style="font-weight:bold;"><i class="fa-solid fa-skull"></i> '.lang('rankings_txt_35').'</td>';
	echo '<td style="font-weight:bold;"><i class="fa-solid fa-bolt"></i> '.lang('rankings_txt_14').'</td>';
	...
	foreach($ranking_data as $rdata) {
		...
		if($i>=1) {
			echo '<tr data-class-id="'.$rdata[1].'" class="align-middle">';
			if(mconfig('rankings_show_place_number')) {
			...
			echo '<td>';
				echo '<div class="row">';
		  		...
		  		echo '</div>';
			echo '</td>';
			echo '<td>'.number_format($rdata[3],0,",",".").'</td>';
			echo '<td><b>'.returnPkLevel($rdata[5],0,",",".").'</b></td>';
