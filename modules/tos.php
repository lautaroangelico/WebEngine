...
<ol class="tos_list">
	...
	<li>
		...
		<p>As creator of your User ID, you are completely responsible for your identity and MuOnline will not tolerate offensive, obscene, or otherwise inappropriate user identities. If a User ID violates any part of these Terms, determined at the sole and absolute discretion of MuOnline Support Staff, we may immediately, temporarily, or permanently ban such User ID from the Site or Service, with or without notice or prior warning.</p>
	</li>
	<li>
	...
	<li>
		<strong>Disciplinary Action and User ID Termination:</strong><br />
		<p>MuOnline can and does issue warnings and temporary suspensions and permanent terminations of user identities for user violations. We retain the sole discretion as to when and how to impose warnings, penalties and/or disciplinary actions. The severity of a violation and number of occurrences factor into the decisions, but they are not the only measures used. User identities may be banned, both temporarily and permanently, without prior warning.</p>
		<p>To avoid any doubt, you acknowledge that MuOnline has sole discretion with respect to penalties and disciplinary actions even if there is a credit remaining on your account.</p>
		<p>If you feel you or your User ID has been unfairly warned or disciplined, please submit a request for help at the MuOnline Helpdesk or send an email with pertinent detail to contact@MuOnline.com. All submitted account action disputes will be carefully reviewed yet MuOnline will only take action with valid claims in its determination.</p>
	</li>
	<li>
		<strong>Payment Gateways:</strong><br />
		<p>MuOnline strives to provide free quality games via the Site and Service. Users are not required to purchase in-game items to fully enjoy the Service, however, Users may charge Virtual Money to their accounts using PaymentWall to acquire those charged Items. Before using either payment gateway, MuOnline recommends you to review their Terms of Service carefully and be sure you agree to their terms separate from this ToS. When you present payment gateway information to MuOnline, you represent to MuOnline that you are the authorized user of such payment gateway account being used to acquire Virtual Money. MuOnline is not affiliated with PaymentWall. If any payment is reversed, cancelled or charged back, your Account with us may be immediately suspended without notice or further be terminated if found fraud.</p>
	</li>
	<li>
		<strong>Abuse of Exploits/Bugs:</strong><br />
		<p>Making use or abusing of any existing/known exploits and/or bugs is completely forbidden.</p>
	</li>
	<li><strong>Server Outages:</strong><br />
		<p>There will be regular periods of server maintenance as well as spot maintenance, usually coinciding with a new game or new service. MuOnline will do its best to limit server down time to twenty four hours. However, MuOnline is not liable for any loss of usage or data experienced as a result of maintenance or other down times and you agree to hold MuOnline harmless for any such loss.</p>
		<p>MuOnline will not be responsible for a user's inability to access paid services during server maintenance.</p>
		<p>MuOnline shall not be liable for any delay or failure to perform resulting from causes outside the reasonable control of MuOnline, including without limitation any failure to perform hereunder due to unforeseen circumstances or cause beyond MuOnline's control such as acts of God, war, terrorism, riots, embargoes, acts of civil or military authorities, fire, floods, accidents, strikes, or shortages of transportation facilities, fuel, energy, labor or materials.</p>
