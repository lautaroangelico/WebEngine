	...
	echo '<div class="panel panel-sidebar">';
		...
		echo '<div class="panel-body">';
			echo '<table class="table">';
				if(isset(config('server_info_season', true))) echo '<tr><td>'.lang('sidebar_srvinfo_txt_6').'</td><td>'.config('server_info_season', true).'</td></tr>';
				if(isset(config('server_info_exp', true))) echo '<tr><td>'.lang('sidebar_srvinfo_txt_7').'</td><td>'.config('server_info_exp', true).'</td></tr>';
				if(isset(config('server_info_masterexp', true))) echo '<tr><td>'.lang('sidebar_srvinfo_txt_8').'</td><td>'.config('server_info_masterexp', true).'</td></tr>';
				if(isset(config('server_info_drop', true))) echo '<tr><td>'.lang('sidebar_srvinfo_txt_9').'</td><td>'.config('server_info_drop', true).'</td></tr>';
				...
				if(isset(config('maximum_online', true))) echo '<tr><td>'.lang('sidebar_srvinfo_txt_5').'</td><td style="color:#00aa00;font-weight:bold;">'.number_format($onlinePlayers).'</td></tr>';
			echo '</table>';
		echo '</div>';
	echo '</div>';
}
